          ...
          <Table className="border-collapse table-fixed w-full">
            <TableHeader className="bg-slate-50 dark:bg-slate-900 border-b border-slate-200 dark:border-slate-800">
              <TableRow className="hover:bg-transparent border-none">
                ...
                <TableHead className="w-52 text-[10px] font-bold text-slate-500 dark:text-slate-400 uppercase tracking-widest px-4 border-r border-slate-200 dark:border-slate-800">Nomor Reg</TableHead>
                ...
                <TableHead className="w-44 text-[10px] font-bold text-slate-500 dark:text-slate-400 uppercase tracking-widest px-4">Tujuan</TableHead>
              </TableRow>
            </TableHeader>
            <TableBody>
