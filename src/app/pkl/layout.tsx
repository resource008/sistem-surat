...
export default function PKLLayout({ children }: { children: React.ReactNode }) {
  ...
  const currentPage = (() => {
    ...
    // Dinamis berdasarkan basePath
    if (pathname.includes("/view/")) return "Data Surat"
    if (pathname.includes("/edit/")) return "Data Surat"
    return "Data Surat"
  })()
    ...
    <div className={styles.root}>
      ...
      >
        <div className={styles.topbar}>
              ...
              {subtitle && subsubtitle ? (
                <>
                  <button
                    ...
                    onClick={() => router.push(`/${role.toLowerCase()}/data-surat`)}
                  >
                    {currentPage}
                  </button>
          ...
          {pathname === `/${role.toLowerCase()}/data-surat` && (
          <>
              <button
                onClick={() => router.push(`/${role.toLowerCase()}/add`)}
