        ...
        <div className="px-6 py-5 flex flex-col gap-4 lg:overflow-y-auto [&::-webkit-scrollbar]:hidden">
          ...
          <div className="flex flex-col gap-4">
            ...
            <FormField label="Tujuan">
              <div className={cn("w-full px-3.5 h-10 flex items-center rounded-xl border text-[14px] font-medium border-slate-200 dark:border-neutral-800 bg-slate-50 dark:bg-neutral-900 cursor-not-allowed select-none", state.form.tujuan ? "text-slate-600 dark:text-slate-400" : "text-slate-400 dark:text-slate-500")}>
