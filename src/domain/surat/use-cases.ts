...
import type { CreateSuratPayload, UpdateSuratPayload, SuratItem } from "./types"

export { applyTujuanToSuratList } from "@/domain/surat/entities"
...
export function validateSuratForm({
  ...
  if (suratList.length === 0) missing.push("Surat")
